...
namespace HM
{
    public partial class Dashboard : Form
    {
            ...
            if (CU_Checkout1.Controls.Contains(CU_Checkout.Instance))           //INSTANCIEI A TELA CHECKOUT
       {
        ...
        {
            if (CU_DetalhesHospede1.Controls.Contains(CU_DetalhesHospede.Instance))                 //INSTANCIEI A TELA DETALHES HÓSPEDE
            {
                CU_DetalhesHospede1.Controls.Add(CU_DetalhesHospede.Instance);
            ...
            {
                CU_DetalhesHospede.Instance.BringToFront();
                CU_DetalhesHospede1.Visible = true;
                CU_DetalhesHospede1.BringToFront();
            }
        ...
        private void Dashboard_Load(object sender, EventArgs e)
        {
            ...
            CU_Registro.Instance.Visible = false;
        }
